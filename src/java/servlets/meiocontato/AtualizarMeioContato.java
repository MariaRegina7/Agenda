...
public class AtualizarMeioContato extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println("<p class='TituloPagina'>Cadastro de Funcionarios </p>");
        
        try{
            ConexaoBancoDados conexao = new ConexaoBancoDados();
            C_MeioContato c_meioContato = new C_MeioContato();
            
            C_MeioContato c_meioContato = new C_MeioContato(request.getParameter("txtTipoContato"), 
                request.getParameter("txtConteudo"), 
                request.getParameter("txtIdContato"); 
                
            
            c_meioContato.setIdMeioContato(Integer.parseInt(request.getParameter("idMeioContato")));
        
            if(conexao.abrirConexao()){
                c_meioContato.configurarConexao(conexao.obterConexao());
            
                if(c_meioContato.alterarRegistro(c_meioContato)){
