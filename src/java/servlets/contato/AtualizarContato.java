...
public class AtualizarContato extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AlterarContato</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AlterarContato at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (conexao.abrirConexao()) {
                ...
                if (contato.alterarRegistro(Contato)) {
                    out.println("<h2>Contato alterado com sucesso!</h2>");
                } else {
                    out.println("<h2>Não foi possível alterar o contato!</h2>");
                }
            ...
            out.println("<h2>Erro do sistema: processo de alteração de contato!</h2>");
        }
